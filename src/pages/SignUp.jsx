  ...
  return (
    <div className='text-white h-screen'>
        ...
        <div className='absolute top-0 left-0 w-full h-screen flex justify-center items-center'>
            <div className='w-[350px] h-[400px] md:w-[400px] md:h-[525px] bg-black/75 z-10 rounded p-10'>
                <h2 className='font-semibold text-2xl md:text-4xl mb-6'>Sign Up</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    />
                    <button className='w-full h-[45px] bg-[#e50914] rounded mb-4'>Sign Up</button>
                    ...
                    <p className='text-gray-500'>Already Subscribed?
                        <Link to='/signin'>
